...
async function fetchUsersStub() {
  return [
    { id: 1, full_name: "Валерий Мартишев", playing_level: "intermediate", favorite_area: "ЦАО", rating: 1250, photo_url: "https://sun9-38.userapi.com/s/v1/ig1/UR4QAZfj_ELHzOV0raKnu6Xd-joa24xNO_xypciMBF7X_CCeaxJJkIAUpne6jjIHr31EYERD.jpg?quality=96&as=32x40,48x60,72x90,108x134,160x199,240x298,360x448,480x597,540x672,640x796,720x895,1080x1343,1125x1399&from=bu&u=o1r68depCDKsUL9rYinTKZekpbTosGV0WD4rPr32nxw&cs=540x0" },
